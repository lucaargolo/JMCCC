...
public class VersionTest extends MinecraftEnvironmentTest {
    ...
    private static final JavaVersionInfo JRE_LEGACY_8 = new JavaVersionInfo("jre-legacy", 8);
    ...
    public static Collection<Object[]> data() {
        ...
        Object[][] params = new Object[][]{
                {"1.6.4", new Version("1.6.4", "release", "net.minecraft.client.main.Main", "legacy", Arrays.asList("--username ${auth_player_name} --session ${auth_session} --version ${version_name} --gameDir ${game_directory} --assetsDir ${game_assets}".split(" ")), Collections.emptyList(), JRE_LEGACY_8, "1.6.4", hashSet(
